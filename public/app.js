...
var GreatLiaisonApp = (function (_React$Component) {
  _inherits(GreatLiaisonApp, _React$Component);

  function GreatLiaisonApp(props) {
    _classCallCheck(this, GreatLiaisonApp);

    _get(Object.getPrototypeOf(GreatLiaisonApp.prototype), 'constructor', this).call(this, props);
  }

  _createClass(GreatLiaisonApp, [{
    key: 'render',
  ...
  return GreatLiaisonApp;
})(React.Component);

exports.GreatLiaisonApp = GreatLiaisonApp;

ReactDOM.render(React.createElement(GreatLiaisonApp, null), document.getElementById('container'));
